...
const SignUpForm = ({ getProgram }: { getProgram: any }) => {
  ...
  // Validation for imgUrl to start with specific URL
  const isValidImgUrl = imgUrl.startsWith('https://pbs.twimg.com')
            ...
            >
              ...
              <button
                disabled={
                  !username ||
                  !displayName ||
                  !imgUrl.startsWith('https://pbs.twimg.com') ||
                  isSigningUp
                }
                type="submit"
              ...
              >
                {!imgUrl.startsWith('https://pbs.twimg.com') &&
                imgUrl.length > 0
                  ? 'Incorrect img url (need twitter pfp link)'
                  : isSigningUp
                  ? 'Signing Up...'
                  : 'Sign Up'}
              </button>
